...
# /api/auth/token
class ApiAuthTokenXHR(BaseHandler):
    # 登录
    # @allow_cross_domain
...
# /auth/refresh-token
class ApiAuthRefreshTokenXHR(BaseHandler):
    # 刷新（代替重新登录）
    # @allow_cross_domain
    @tornado.web.asynchronous
    @tornado.gen.coroutine
...
# /api/auth/accounts
class ApiAuthAccountXHR(BaseHandler):
    # 注册
    # @allow_cross_domain
    @tornado.web.asynchronous
    @tornado.gen.coroutine
...
# /auth/verify-code
class ApiAuthVerifyCodeXHR(BaseHandler):
    # 获取验证码
...
# 创建忘记密码的验证码
# 使用sendcloud实现
class ApiSendCloudVcodeXHR(BaseHandler):
    @tornado.web.asynchronous
    @tornado.gen.coroutine
    def post(self):
        logging.info(self.request)
...
# /auth/pwd
class ApiAuthPwdXHR(BaseHandler):
    # 修改密码
    # @allow_cross_domain
    @tornado.web.asynchronous
    @tornado.gen.coroutine
